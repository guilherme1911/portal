...
export default function PdfICMS2014(){

  const abrirSite1 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/01_ICMS_Janeiro_2014.pdf'); 
  };
  const abrirSite2 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/02_ICMS_Fevereiro_2014.pdf'); 
  };
  const abrirSite3 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/03_ICMS_Marco_2014.pdf'); 
  };
  const abrirSite4 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/04_ICMS_Abril_2014.pdf'); 
  };
  const abrirSite5 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/05_ICMS_Maio_2014.pdf'); 
  };
  const abrirSite6 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/06_ICMS_Junho_2014.pdf'); 
  };
  const abrirSite7 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/07_ICMS_Julho_2014.pdf'); 
  };
  const abrirSite8 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/08_ICMS_Agosto_2014.pdf'); 
  };
  const abrirSite9 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/09_ICMS_Setembro_2014.pdf'); 
  };
  const abrirSite10 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/10_ICMS_Outubro_2014.pdf'); 
  };
  const abrirSite11 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/11_ICMS_Novembro_2014.pdf'); 
  };
  const abrirSite12 = () => {
    Linking.openURL('http://arquivos.setc.se.gov.br/ICMS/2014/12_ICMS_Dezembro_2014.pdf'); 
  };
  ...
  const voltarPagina = () => {
    ...
    return (
      ...
      <View style={styles.subtitulo2}>
        ...
        Transferência aos Municípios - ICMS - 2014
        </Text>
      </View>
